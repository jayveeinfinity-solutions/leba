<article class="module desktop-9 tablet-12">
	<div class="ib_wrapper bg_gr">
		<div class="ib_dashboard">
			<h1><i class="fa fa-user"></i> View User &nbsp;<a href="?tab=users"><span class="ib_dashboard_btn bg_green"><i class="fa fa-arrow-left"></i> Return to users</span></a> &nbsp;<a href="?tab=users&action=edit&id=<?php echo $_GET['id']?>"><span class="ib_dashboard_btn bg_green"><i class="fa fa-pencil"></i> Edit</span></a> &nbsp;<a href="?tab=users&action=change_pass&id=<?php echo $_GET['id']?>"><span class="ib_dashboard_btn bg_green"><i class="fa fa-key"></i> Change Password</span></a></h1>
		</div>
		<div class="ib_content">
			...
			<form class="ib_dashboard_form bg_white" action="" method="POST" enctype="multipart/form-data">
				...
				<input class="ib_dashboard_input" type="text" name="username" placeholder="*Username" value="<?php echo IB_User::getUserData('UN', $_GET['id']);?>" autocomplete="off" readonly>
				<label class="ib_dashboard_label" for="email">Email</label>
				<input class="ib_dashboard_input" type="email" name="email" placeholder="*Email" value="<?php echo IB_User::getUserData('EM', $_GET['id']);?>" autocomplete="off" readonly>
				<label class="ib_dashboard_label" for="role">Role</label>
				<select class="ib_dashboard_input" name="role" readonly disabled>
					<?php
						if(IB_Role::getRoles()) {
